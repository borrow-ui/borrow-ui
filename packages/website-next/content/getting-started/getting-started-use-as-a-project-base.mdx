...
This project is setup to work with [yarn workspaces](https://yarnpkg.com/features/workspaces).
...
<Terminal
    title="Quick start"
    code={`curl -LJO https://github.com/borrow-ui/borrow-ui/archive/master.zip;
...
<Terminal code={`find . -type f -print0 | xargs -0 sed -i 's/borrow-ui/my-ui-name/g'`} />

### Install dependencies

From the main folder, run:

<Terminal code={`yarn # this will install all the dependencies`} />

#### Initialize the git repository (optional)

As a good practice, initialize the folder as a repository and set a remote origin; if you are using GitHub, you
...
<Terminal code={`yarn workspace @my-ui-name/documentation run storybook`} />
...
<Terminal code={`yarn workspaces @borrow-ui/website-next add react-dropzone`} />
...
<Terminal code={`yarn workspaces @borrow-ui/website-next remove react-dropzone`} />
