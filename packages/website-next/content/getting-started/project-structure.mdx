...
want to [include](/getting-started/getting-started-include-in-an-existing-project)
...
Inside the packages you can add other packages as dependencies and `yarn` and `lerna` will be smart enough to link them.

In this scenario, `lerna` will be useful as a publishing tool, to optimize packages management and to run commands in parallel.
