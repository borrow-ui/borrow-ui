                ...
                <Col colClassName="col-sm-12 col-md-6">
                    <Text className="m-t-10">
                        ...
                        <ul>
                            ...
                            <li>
                                <Monospace>documentation</Monospace>: Storybook project already
                                setup and connected to the components
                            </li>
                            <li>
                                <Monospace>website-next</Monospace>: the code of this website
                            </li>
                        </ul>
                    </Text>
                </Col>
