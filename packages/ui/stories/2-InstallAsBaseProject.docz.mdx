---
name: Use as a project base
route: /introduction/getting-started-use-as-a-project-base
menu: Installation
---
...
The `packages/documentation` folders contains this guide backbone and the `docz` configuration files.
Two commands are available:

-   `yarn docz:dev` to start [Docz](https://www.docz.site/) server in development mode.
...
-   `yarn docz:build` to build the documentation for production.
