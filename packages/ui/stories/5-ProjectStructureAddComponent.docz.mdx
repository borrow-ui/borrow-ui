...
route: /project-structure/add-a-component
...
To add a Docz mdx file for the component, create a `src/components/red-link/RedLink.docz.mdx` file:

```mdx
---
name: Red Link
route: /components/red-link
menu: Components
---
