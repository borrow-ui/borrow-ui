...
<Meta title="Project Structure|Introduction" />
...
want to [include](?path=/docs/getting-started-installation-include-in-an-existing-project--page#include-in-an-existing-project)
...
Go to the [next section](?path=/docs/project-structure-ui-package--page#ui-package) to see how it is organised.
