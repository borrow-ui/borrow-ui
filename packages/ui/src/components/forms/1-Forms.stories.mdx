...
The standard way to represent forms is by using a label-controller couple.
...
export function Form({ initialValues, onSubmit }) {
    ...
    return <form onSubmit={onFormSubmit}>
        ...
        <div>
            <Button type="submit" mean="positive">Save</Button>
        </div>
    </form>;
}
```
...
<Preview>
    <Story name="Default">
        <div className="storybook-container borrow-ui">
            <FormsStoryWrapper initialState={{ useInternet: true }}>{({ state, setState }) => {
                return <div style={{ width: 400 }}>
                    ...
                    <Field label="Favourite day of weekend">
                        <Forms.Select
                            ...
                            onChange={option => setState({ ...state, favouriteWeekendDay: option.value })}
                            options={[
                        ...
                        <div className="m-t-5">
                            <div className="m-b-10">
                                <Checkbox
                                    ...
                                    onClick={e => setState({ ...state, smartphone: !!!state.smartphone })}
                                />
                            </div>
                            <div className="m-b-10">
                                <Checkbox
