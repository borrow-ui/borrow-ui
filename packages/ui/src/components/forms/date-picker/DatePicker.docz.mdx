---
name: DatePicker
route: /components/forms/date-picker
menu: Forms
---
                ...
                <div style={{ width: 400, height: 350 }}>
                    <Field label="Select a date">
                        <DatePicker
                            returnPartial={false}
                            onDayChange={(date) => {
                                console.log('DatePicker `returnPartial`: date changed to', date);
                                setState({
                                    ...state,
                                    select_date: date,
                                });
...
<Playground>
    <FormsStoryWrapper initialState={{ disabled_date: '2020-06-25', invalid_date: '2020-04-01' }}>
        {({ state, setState }) => {
            return (
                <div style={{ width: 400, height: 400 }}>
