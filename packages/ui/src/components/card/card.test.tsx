    ...
    test('renders title, subtitle and description', () => {
        render(
            <Card
                ...
                mainProps={{ 'data-testid': 'main-container' } as TestableDiv}
                bodyProps={{ 'data-testid': 'body-container' } as TestableDiv}
    ...
    test('renders icon on the side', () => {
        render(
            <Card
                ...
                title="Home"
                description="This is the address"
                sideProps={{ 'data-testid': 'side-container' } as TestableDiv}
                iconContainerProps={{ 'data-testid': 'icon-container' } as TestableDiv}
                mainProps={{ 'data-testid': 'main-container' } as TestableDiv}
            />
        );
    ...
    test('renders with controls', () => {
        render(
            <Card
                ...
                controlsProps={{ 'data-testid': 'controls-container' } as TestableDiv}
            />
        );
