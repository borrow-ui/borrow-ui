...
<Meta title="Internal/Components/ReferenceOverlay" component={ReferenceOverlay} />
...
<Preview>
    <Story name="Default">
        <div className="storybook-container">
            ...
            <ReferenceOverlay
                overlayContent="You can click anywhere to close this!"
                className="m-r-20"
                triggerMode="click"
                placement="bottom"
            >
            ...
            <ReferenceOverlay
                overlayContent="You must click the trigger to close this message!"
                className="m-r-20"
                placement="bottom"
                triggerMode="click"
                clickPersist={true}
