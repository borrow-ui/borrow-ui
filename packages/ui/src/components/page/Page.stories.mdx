    ...
    <Story name="Default">
        <div style={{ height: 400, fontSize: '14px', overflow: 'hidden' }}>
            <Page title="Page Title" style={{ height: '100%' }}>
                <Text>
                    This content will be rendered inside the body of the page,
                    via <Monospace>PageBody</Monospace> component.
                </Text>
                <Lorem paragraphs={3} />
                <Lorem paragraphs={3} />
            </Page>
    ...
    <Story name="PageHeader controls">
        <div style={{ height: 400, fontSize: '14px', overflow: 'hidden' }}>
            <Page
                ...
                pageHeaderProps={{
                    controls: <Fragment>
                        <Button onClick={() => window.alert('clicked')} mean="primary">Add item</Button>
                        <Icon name="settings" className="m-l-5 color-neutral" onClick={() => window.alert('settings')} />
                    </Fragment>
                }}
            >
                <Lorem paragraphs={3} />
